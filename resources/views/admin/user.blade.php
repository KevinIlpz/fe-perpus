    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-md p-4 flex justify-between items-center">
                ...
                <div>
                    <button onclick="window.location.href='/admin/create-user'" class="bg-blue-500 text-white px-4 py-2 rounded">
                        Add
                    </button>
                </div>
            </header>
                ...
                <table class="w-full bg-white shadow-md rounded">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">admin123</td>
                            <td class="py-3 px-6 text-center">
                                ...
                                <div id="options-{{ $i }}" class="hidden mt-2 space-y-2">
                                    <a href="{{ route('admin.edit-user', $i) }}" class="block bg-gray-100 px-4 py-1 rounded hover:bg-blue-100">Edit</a>
    ...
    <script>
        ...
        function confirmDelete(id) {
            ...
            if (confirmed) {
                ...
                window.location.href = ``; // Sesuaikan dengan endpoint penghapusan
            }
        }
    </script>
@endsection
